...
public class VisitorPattern {
	public static void main(String[] args) {
		...
		System.out.println("On road Price of "+car.getModel()+" is "+car.accept(new WorkShopVisitorImp())+" lakhs");
		
		VechileItem bike = new Bike("GT 650",3);
		System.out.println("On road Price of "+bike.getModel()+" is "+bike.accept(new WorkShopVisitorImp())+" lakhs");
	}
}


/*
 * Visitor interface which accepts Vechile Item type object and perform operations on them
 */
 ...
 * which will do the operation on the vehicle objects by passing it to visitor function
 */
