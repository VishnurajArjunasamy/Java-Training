...
/*
 * Controller which does all the job of client ,based on the input Initially
 * assigning a command and executing the command if client requested
 */
...
/*
 * client tells the Controller to do the operation based on the input he has
 * given Like in heavy traffic area maintain slow speed Or in Highway it can go
 * in speed above average Or maintain a moderate speed.
 */
